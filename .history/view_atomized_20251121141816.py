...
if __name__ == "__main__":
    # Load data
    data = load_atomized_data("/Users/4jp/Downloads/Tomb_of_the_Unknowns_atomized.json")
    
    # Create sample view
    create_sample_view(data, "/Users/4jp/Downloads/atomized_sample.txt")
    print("Sample view created: atomized_sample.txt")
    
    # Create index
    create_index(data, "/Users/4jp/Downloads/atomized_index.txt")
    print("Index created: atomized_index.txt")
